...
declare module 'quick.db' {
    ...
    /**
     * This function fetches everything that stars with a certain string.
     * @param {str} input any string as a str.
     * @param {options} [input={ sort: fallse, sortBy: null }] Any options to be added to the request.
     * @returns {data} an array of the sorted data.
     */
    function startsWith(str: string, ops?: object): any;
     ...
     */
    function all(ops?: object): object;
    function fetchAll(ops?: object): object;
